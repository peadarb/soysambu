...
data <- data.frame(
  "Location" = c("Mbaruk", "Oljorai", "Soysambu", "Kiptangwanyi"),
...
```{r fig, fig.cap='\\label{fig:liveli2}Map of 2nd most important livelihood in surveyed households', fig.align='center', out.width = '90%'}
