...
Despite efforts to reduce negative social impacts of Soysambu on
...
3.  Lack of appreciation of community during emergencies
...
In Mbaruk and Oljorai locations, the majority of people felt there is
...
the communities, notably in Kiptangwanyi, Oljorai, and Mbaruk. Soysambu
residents show mixed views.

#### Mitigation of Negative Impacts

Residents in Kiptangwanyi, Oljorai, and Mbaruk expressed scepticism
...
Oljorai regarding perceived fairness in benefit distribution from
...
and respect for rights of local women and men.
...
engagement in governance decision impact the community, and the fact
...
-   **Education**: There were requests to support schools and education
    ...
    construction of primary schools, installation of facilities like
...
-   **Agricultural outreach:** Tied to this, and requests about
    livestock and agriculture, were also requests to educate farmers on
    ...
    provision of fodder and compensation for losses due to wildlife
...
-   **Water:** There was a lot of concern expressed over access and
...
-   **Environmental Conservation:** There were also requests to support
    the community to plant tress in a number of areas (e.g. Chamuka
...
chosen, because it meets the requirements of Soysambu Conservancy as
they seek to understand social impacts over time, and to listen to feed
back from communities living within and surrounding the conservancy.
...
and negative social impacts and measures of well-being were being
covered in the assessments; that a sufficient number of households would
be sampled; and that the assessment would be suitable to the cultural
context.
...
introductions to the heads of village. At this stage, the survey team
...
issues, that were informed by concerns raised during reconnaissance
visits and reports from the Soysambu Conservancy team. Furthermore,
custom governance questions and statements were developed key governance
principles of conserved areas which address rights, participation,
...
Soysambu loaction was made up of 4 settllements at Jolai 1,2, Sleeping Warrior Gate, Jolai Gate and Soysambu Area.
...
113 men and 68 women participating. As the Figure 2 below shows, across
all surveyed locations, the number of male respondents exceeded the
number of women, with the greatest gender disparity in respondents found
in the communities living within Oljorai (see Figure 2 below). Mbaruk on
...
Pipeline-Elementaita road, there exists a satellite urban settlement
...
The survey results show
 ...
 -   This was different in **Oljorai where the majority of respondents were been born in the area** (83%), with a minority
...
smart phone, water tank, pit latrine, and whether they used mpesa,
...
cultivated. Based on a principal component analysis, households were
categorised into 5 quintiles, and a map of these is shown in figure
5 below, followed by two key variables in understanding household
level wealth, namely how often the household were forced to skip a
...
proportions of households across themese suggesting that Soysambu had a high positive
impact.**
...
-   Additionally, **Soysambu's contributions to local schools**,
    ...
    uniforms, desks, and sports equipment, **positively impact
    educational outcomes and student well-being (20.4%).*
...
-   Soysambu conservancy's support for health project**s,
...
-   Soysambu conservancy **provides water to the community**
    either through trucks or by building water tanks, ensuring
    access to clean and safe water for local residents, and this
...
-   Soysambu conservancy's support in **building or maintaining
    ...
    were reported to enhance the overall quality of life for
...
-   Soysambu actively participates in **environmental
    ...
    biodiversity **(21.3%)**
-   Moreover, Soysambu offers support to **bush-clearing workers
    by providing firewood for free**, demonstrating a commitment
    to employee welfare and community support **(21.9%).**
...
Although Soysambu Conservancy have made recent efforts to
...
shared, for example, there was a large concern on **limited employment opportunities** and a lack of prioritisation in employment within Soysambu **(89.5%)**. This was the largest negative impact cited by communities.
...
#### Households reporting that `r fontawesome::fa("cow")` crops were damaged by wild animals in the last year
...
- However, despite the lowest reporting wellbeing, **Soysambu residents reported they had the greatest increase in well-being in the last 5 years (54%).**

- Most other areas reported little change to well-being. 

- Then, once the respondent was asked about the positive and negative impacts of Soysambu conservancy, they were asked if they could take into account all of these impacts discussed, and summarise the overall impact of Soysambu on the well-being of their household. **This confirms that Soysambu conservancy have improved their own residents wellbeing in the last 5 years.** It also 
...
respondents were asked how has the contribution of Soysambu to your
household's well-being changed over the past 5 years?
...
considerable number chosing to answer *"Don't know"*, when asked
...
In Kiptangwanyi, Oljorai, and Mbaruk locations, results suggest that
...
Soysambu and its associated negative impacts, shown in Figure
below.

The household survey results show diverse perspectives across
locations. In Kiptangwanyi, Oljorai and Mbaruk, most respondents
disagreed that an effective system for collecting information on
damage caused by wild animals existed, as well a lack of help when
...
damage. The exception here was Oljorai where the majority still
...
### Equitable benefit-sharing processe
...
### Right
In SAPA, prioritizing recognition and respect for rights of all
...
In response to the overall statement, in Oljorai and Soysambu, the majority disagreed
with this statement, with a few in Mbaruk and Kiptangwanyi expressing similar views.

Conversely, a few respondents in Kiptangwanyi and Mbaruk, as well as most in Oljorai and Soysambu,
agreed with the statement When it came to the community's perceived right to harvest firewood, respondents in Soysambu felt that they had rights to harvest firewood.

There were mixed responses in all other locations regarding law enforcement staff potentially violating the law or
local people's rights, the majority of respondents from Kiptangwanyi, Oljorai, and Soysambu disagreed. This result goes
counter to some of the claims that were made in the open ended questions (see section in "From assessment to action" below).
...
given an opportunity to brainstorm and add further suggestions based on results form the survey tool.
...
**Action: Develop a clear strategy for engaging with health clinics, dispensaries and schools including infrastructure development and support for health workers. CHASE Africa, is one of the leading NGSO in the region, working with conservation practionores to improve the outcomes of health care in conservation landscapes.**
...
- and cessation of harassment by security personnel on
herders.
...
decision made by Soysambu that would affect them, nor that their
...
reported in other surveyed areas. 
...
implementation challenges, include:
 - Prioritizing employment opportunities for community members within the conservancy, which could be advertised and seleected through a community committee. 
