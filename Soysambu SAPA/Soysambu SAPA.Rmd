...
Pipeline-Elmentaita road, there exists a satellite urban settlement
...
-   Soysambu actively participates in **environmental
    ...
    biodiversity **(21.3%)**
-   Moreover, Soysambu shows a dedication to employee well-being and community
    assistance **(21.9%)** by **supporting bush-clearing workers with free firewood**.
...
Elmentaita dispensary in Elmentaita village.
...
heading to Elmentaita around Maisha poa area, a water pan in Kampi
...
df <- data.frame(
  ...
  Suggestion = c(
    ...
    "Improvement of health facilities in various locations such as Kampi Turkana and Kapkures.", "Equipping the maternity wing at the Elmentaita dispensary.", "Installation of water infrastructure including boreholes and water towers.", "Construction of dams, boreholes, and water towers.", "Revival of existing boreholes and extension of water infrastructure.",
